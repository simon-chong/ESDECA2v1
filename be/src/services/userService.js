...
module.exports.getOneUserData = function(recordId) { //also want here
        logger.info('getOneUserData method is called.');
        logger.info('Prepare query to fetch one user record');
...
module.exports.getOneDesignData = function(recordId) {
        ...
        logger.info('Prepare query to fetch one design record');
...
module.exports.createOneEmailInvitation =  (userData,recipientName, recipientEmail) => {
    ...
    return new Promise((resolve, reject) => {
        ...
        logger.info('Inspect whether the userData variable has content:')
